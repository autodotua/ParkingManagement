...
namespace Park.Mgt.Models
{
    ...
    public static class ParkMgtDatabaseInitializer
    {
        public static void Initialize(ParkMgtContext context)
        {
        ...
        private static List<Menu> GetMenus(ParkMgtContext context)
        {
